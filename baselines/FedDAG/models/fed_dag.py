...
import sys
import numpy as np
from baselines.FedDAG.models.nonlinear.masked_nn import MaskedNN
from baselines.FedDAG.models.linear.notears import NoTears
from baselines.FedDAG.trainers import ALTrainer, NoTears_ALTrainer
from baselines.FedDAG.helpers.train_utils import callback_after_training
from baselines.FedDAG.helpers.base import BaseLearner
...
class GS_FedDAG(BaseLearner):
    ...
    def _noniidfedcd(self, X, pns_mask):
        ...
        trainer = ALTrainer(self.init_rho, self.rho_thres, self.h_thres,
                            self.rho_multiply, self.init_iter, self.h_tol,
                            self.temperature, self.it_fl, sess, ops_set, None)
